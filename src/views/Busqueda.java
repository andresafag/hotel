		...
		btnbuscar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
						...
						if (txtBuscar.getText().length() > 0) {
							...
							for (int i = 0; i < 1; i++) {
								try {
									...
									System.out.println("Atrapamos el error");
									JOptionPane.showMessageDialog(null,"You entered an unexisistance value", "Value does not exist", JOptionPane.WARNING_MESSAGE);
								}
							}
					...
					JOptionPane.showMessageDialog(null,"You entered letters and this field requires you to enter only numbers", "Wrong input", JOptionPane.WARNING_MESSAGE);
				}
