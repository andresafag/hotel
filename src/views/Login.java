...
public class Login extends JFrame {
	...
	private void permitir() {
		String passwd=new String (txtContrasena.getPassword());	    
     
        if(HostController.allow(txtUsuario.getText(), passwd)){
        	// Here we verify the user and the password in the mysql database
